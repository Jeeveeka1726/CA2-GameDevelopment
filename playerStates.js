...
export class Sitting extends State {
    constructor(game){
       super("SITTING", game); //To trigger constructor of it's parent class
    }
    enter(){
...
export class Running extends State {
    constructor(game){
       super("RUNNING", game); //To trigger constructor of it's parent class
    }
    enter(){
        this.game.player.maxFrame = 0;
...
export class Jumping extends State {
    constructor(game){
       super("JUMPING", game); //To trigger constructor of it's parent class
    }
    enter(){
...
export class Falling extends State {
    constructor(game){
       super("FALLING", game); //To trigger constructor of it's parent class
    }
    enter(){
        this.game.player.maxFrame = 0;
        this.game.player.maxFrame = 6;
...
export class Rolling extends State {
    constructor(game){
       super("ROLLING",game); //To trigger constructor of it's parent class
    }
    enter(){
        this.game.player.maxFrame = 0;
        this.game.player.maxFrame = 6;
...
export class Diving extends State {
    constructor(game){
       super("DIVING",game); //To trigger constructor of it's parent class
    }
    enter(){
        this.game.player.maxFrame = 0;
        this.game.player.maxFrame = 6;
...
export class Hit extends State {
    constructor(game){
       super("HIT",game); //To trigger constructor of it's parent class
    }
    enter(){
        this.game.player.maxFrame = 0;
